  ...
  return (
    <section className='hero-section'>
        <div className="size-full mask-wrapper">
            ...
            <img src="/images/watch-trailer" className='trailer-logo' alt="trailer" />
        ...
        <div>
            <img src="/images/big-hero-text.svg" className='size-full object-cover mask-logo' alt="logo" />
        </div>

        <div className='fake-logo-wrapper'>
            <img src="/images/big-hero-text.svg" className='overlay-logo' alt="overlay-logo" />
        </div>
